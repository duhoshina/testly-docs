...
<CardGroup cols={2}>
  ...
  <Card title="Conta Testly" icon="user-check">
    [Crie uma conta grátis](https://testly.com/signup)
  </Card>
  <Card title="API Key" icon="key">
    Encontrada no [dashboard](https://testly.com/dashboard)
  </Card>
</CardGroup>
...
<Warning>
  **Importante**: Sempre use variáveis de ambiente para armazenar sua API Key. Nunca faça commit dela no código!
</Warning>
...
<Tip>
  **Recomendado**: Ative `debug: true` em desenvolvimento para facilitar troubleshooting!
</Tip>
