...
<Tip>
  **Dica de ouro**: Ative o `debug: true` durante o desenvolvimento. Isso vai te salvar horas de debugging! 🐛
</Tip>

---

[**Pronto para experimentar? Crie sua conta grátis 🚀**](https://testly.com/signup)